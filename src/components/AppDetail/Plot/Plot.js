...
export default function Plot(props) {
    ...
    return (
        <Flex width={64} minH={64} direction={'column'} align={'center'} background={'#13161b'} shadow={'lg'} borderRadius={5} pos={"relative"} >
            ...
            {item.loaded ?
                <>
                    <Flex w={'100%'} direction={'row'} justify={'space-around'} align={'center'} mt={1}>
                        <Flex bg={"#282c34"} p={2} flexDirection={'row'} justify={'center'} align={'center'} borderRadius={10}>
                            <Image src='axie.png' w={4} h={4} mr={2} />
                            <Text
                                color={"white"}
                                fontWeight={'bold'}
                                fontSize={11}
                            >
                                {props.item.plotDetail.number_of_workers - props.item.plotDetail.number_of_working_workers}/{props.item.plotDetail.number_of_workers}
                            </Text>
                        </Flex>
                        <Flex bg={"#282c34"} p={2} flexDirection={'row'} justify={'space-around'} align={'center'} borderRadius={10}>
                            <Image src='npc.png' w={4} h={4} mr={2} />
                            <Text
                                color={"white"}
                                fontWeight={'bold'}
                                fontSize={11}
                            >
                                {props.item.plotDetail.number_of_idle_npcs}/{props.item.plotDetail.number_of_npcs}
                            </Text>
                        </Flex>
                        <Flex bg={"#282c34"} p={2} flexDirection={'row'} justify={'space-around'} align={'center'} borderRadius={10}>
                            <Image src='construct.png' w={4} h={4} mr={2} />
                            <Text
                                color={"white"}
                                fontWeight={'bold'}
                                fontSize={11}
